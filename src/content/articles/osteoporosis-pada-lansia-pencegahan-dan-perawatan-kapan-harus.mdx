...
imagePrompt: "Nanobanana Pro 2 prompt: Indonesian, healthcare, professionals, taking care of patient, an Indonesian healthcare specialist explaining bone density charts and therapeutic posture exercises to an active elderly Indonesian couple, calm indoor living room, ergonomic home safety environment. Focusing on topic 'Kapan Osteoporosis Butuh Terapi Khusus? Protokol Klinis'. Primary keyword: statistik osteoporosis di indonesia pada lansia. Authentic Indonesian faces, warm natural window light, soft shadows, realistic medical scrubs and clinical equipment, impeccable hygiene, cinematic shallow depth of field, high-end commercial healthcare editorial photography, Hasselblad H6D-100c, 50mm lens, f/2.0, ISO 100, 8k resolution, photorealistic, masterwork --ar 16:9 --style raw"
---
