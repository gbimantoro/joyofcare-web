---
title: 10 Tanda Awal Demensia pada Lansia Waspada
metaTitle: 10 Tanda Awal Demensia pada Lansia Waspada | Joy of Care
metaDescription: Kenali 10 tanda awal demensia alzheimer pada orang tua dan langkah penanganannya di rumah. Hubungi dokter via WhatsApp Joy of Care 08811-118-911 sekarang!
category: perawatan-lansia
author: Tim Kontributor Artikel
reviewer: Tim Medis Joy of Care
date: '2026-08-23'
slug: ortu-sering-lupa-awas-mungkin-ini-10-tanda-demensia-yang-sering-kelewat-21
featuredImage: /assets/images/articles/ortu-sering-lupa-awas-mungkin-ini-10-tanda-demensia-yang-sering-kelewat-21.webp
primaryKeyword: tanda awal demensia pada lansia
secondaryKeywords:
- gejala alzheimer orang tua
- perbedaan lupa wajar dan demensia
- tes skrining daya ingat mmse
...
faq:
- question: Apa perbedaan utama antara lupa wajar karena usia tua dan gejala demensia?
  answer: '''Lupa wajar: lansia lupa di mana meletakkan kacamata namun bisa mengingatnya kembali nanti. Demensia: lansia lupa nama anak kandung, tersesat di lingkungan rumah sendiri, atau lupa fungsi dasar dari benda seperti sisir atau sendok.'''
- question: Apakah penyakit demensia Alzheimer bisa disembuhkan secara total?
  answer: Hingga saat ini belum ada obat yang menyembuhkan Alzheimer secara tuntas, namun diagnosis dini dan intervensi obat inhibitor asetilkolinesterase dapat memperlambat kerusakan sel otak dan mempertahankan fungsi mandiri lebih lama.
- question: Bagaimana cara terbaik berkomunikasi dengan orang tua penderita demensia saat mereka mengulang pertanyaan?
  answer: Jawablah dengan sabar menggunakan kalimat pendek dan intonasi tenang. Jangan membantah atau berkata 'Kan tadi sudah Ibu tanyakan!', karena hal itu akan memicu kecemasan dan kemarahan pasien.
...
1. **Jangan Membantah atau Mempermalukan**: Jangan mendebat ingatan orang tua yang salah; alihkan topik dengan lembut.
2. **Lakukan Skrining Kognitif Resmi**: Bawa orang tua ke dokter spesialis saraf untuk tes skrining neurokognitif baku seperti **MMSE** (*Mini-Mental State Examination*) atau **MoCA-Ina** (*Montreal Cognitive Assessment versi Indonesia*).
3. **Pemeriksaan Fisik & Darah**: Dokter akan memeriksa kadar tiroid, vitamin B12, dan fungsi organ untuk menyingkirkan demensia reversibel yang disebabkan oleh gangguan metabolik.
