...
imagePrompt: "Nanobanana Pro 2 prompt: Indonesian, healthcare, professionals, taking care of patient, a dedicated Indonesian physiotherapist gently supporting and guiding an adult patient through knee rehabilitation and mobility exercises on a yoga mat in an airy living room, encouraging smile, resistance bands, orthopedic care. Focusing on topic 'Mengatasi Nyeri Rahang Kliking & Sakit Kepala Samping (...'. Primary keyword: mengatasi nyeri rahang kliking sakit kepala samping. Authentic Indonesian faces, warm natural window light, soft shadows, realistic medical scrubs and clinical equipment, impeccable hygiene, cinematic shallow depth of field, high-end commercial healthcare editorial photography, Hasselblad H6D-100c, 50mm lens, f/2.0, ISO 100, 8k resolution, photorealistic, masterwork --ar 16:9 --style raw"
---
