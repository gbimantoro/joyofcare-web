...
imagePrompt: "Nanobanana Pro 2 prompt: Indonesian, healthcare, professionals, taking care of patient, a Joy of Care medical escort nurse accompanying a wheelchair-bound patient comfortably into a specialized medical transport ambulance, clean hospital transfer setup in Jakarta, attentive patient safety focus. Focusing on topic 'Antar Jemput RS: Joy of Care vs Taksi'. Primary keyword: antar jemput ke rs joy of care vs transport lain. Authentic Indonesian faces, warm natural window light, soft shadows, realistic medical scrubs and clinical equipment, impeccable hygiene, cinematic shallow depth of field, high-end commercial healthcare editorial photography, Hasselblad H6D-100c, 50mm lens, f/2.0, ISO 100, 8k resolution, photorealistic, masterwork --ar 16:9 --style raw"
---
